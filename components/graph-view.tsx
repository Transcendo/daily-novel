...
export function GraphView(props: GraphViewProps) {
  ...
  return (
    <div
      ref={ref}
      className="relative h-[600px] overflow-hidden rounded-lg border bg-fd-background [&_canvas]:size-full"
    >
...
function ClientOnly({
  ...
  return (
    <>
      ...
      {tooltip && (
        <div
          className="absolute size-fit max-w-xs rounded-lg border bg-fd-popover p-2 text-sm text-fd-popover-foreground shadow-lg"
